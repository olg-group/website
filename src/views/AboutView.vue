...
import {faArrowUp, faCross, faFlask, faGlasses, faHeart, faLock, faServer} from "@fortawesome/free-solid-svg-icons";
...
<template>
  <main>
    ...
    <CenteredContentSection>
      ...
      <template #body>
        <p>
          At The OLG Group, we specialize in providing expert IT and management consulting services, coupled with
          innovative software solutions.
          With a primary focus on small companies and startups, we are committed to empowering businesses like yours to
          thrive in today's digital landscape.
          Whether you're seeking guidance on IT strategies, business process optimization, or software development, we
          have the expertise and resources to support you every step of the way.
          Our ultimate vision is to foster a digital-powered society, leveraging modern technologies and solutions to
          drive innovation and growth.
          Join us at The OLG Group, and let's embark on a journey towards a more efficient and digitally empowered
          future together.
        </p>
        <ul role="list" class="mt-8 space-y-8 text-gray-600">
          <li class="flex gap-x-3">
            <FontAwesomeIcon :icon="faArrowUp" class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true"/>
          ...
          <li class="flex gap-x-3">
            <FontAwesomeIcon :icon="faServer" class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true"/>
        ...
        <p class="mt-8">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id blandit molestie
        ...
        <p class="mt-6">Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam consequat in. Convallis arcu ipsum
          urna nibh. Pharetra, euismod vitae interdum mauris enim, consequat vulputate nibh. Maecenas pellentesque id
          sed tellus mauris, ultrices mauris. Tincidunt enim cursus ridiculus mi. Pellentesque nam sed nullam sed diam
    ...
    >
      ...
      <template #description>Driven by our management, our team unites diverse disciplines to innovate in technology and
        business consulting.
      </template>
    </TeamSection>
  </main>
